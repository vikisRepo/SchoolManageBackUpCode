...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'e-letter/:id/:myletter', loadChildren:()=>import('./staff/e-letter/e-letter.module').then(m=>m.ELetterModule)},
      { path: 'e-letter-list', loadChildren:()=>import('./staff/e-letter-list/e-letter-list.module').then(m=>m.ELetterListModule)},
      { path: 'e-letter-list/:id', loadChildren:()=>import('./staff/e-letter-list/e-letter-list.module').then(m=>m.ELetterListModule)},
      ...
      { path: 'staff-feedback-list/:id',loadChildren:()=>import('./staff/staff-feedback-list/staff-feedback-list.module').then(m=>m.StaffFeedbackListModule)},
      ...
      { path: 'student-feedback-list/:id',loadChildren:()=>import('./student/student-feedback-list/student-feedback-list.module').then(m=>m.StudentFeedbackListModule)},
      ...
      { path: 'add-bus-details/:id', loadChildren: () => import('./transport/add-bus-details/add-bus-details.module').then(m => m.AddBusDetailsModule) },
